...
const ServicesPage = () => {
  return (
    <div className="">
      <PageBannerSec
        image={servicesMenuImg}
        title="Our Services"
        description="With years of experience in healthcare finance, we offer tailored solutions that drive efficiency, reduce financial risks, and maximize profitability while keeping patient care at the forefront"
      />
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          {services.map((service, index) => (
            ...
            >
              ...
              />
              <div className="absolute bottom-0 w-full h-20 bg-opacity-30 rounded-2xl backdrop-blur-md bg-[#032237] py-2 flex items-center justify-center transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-full">
