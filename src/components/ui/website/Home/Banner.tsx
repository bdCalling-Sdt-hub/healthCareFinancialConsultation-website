  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-1/2 left-[200px] md:left-1/3 transform -translate-x-1/2 -translate-y-1/2 space-y-5">
        <h1 className="text-3xl md:text-5xl px-5 md:px-0 font-bold md:w-[600px] text-transparent bg-gradientBg bg-clip-text">
        ...
        <button className="bg-gradientBg px-5 ms-5 md:ms-0 py-2 rounded-md border-none">
          Book Now
        </button>
      </div>
    </div>
